...
$data = array(
    ...
    'return_url' => 'http://www.unihorn.tech/admin/data-table.php', //必须的，支付成功后的跳转地址
    'callback_url' => 'http://www.unihorn.tech/admin/faildpay.php', //必须的，支付发起地址（未支付或支付失败，系统会会跳到这个地址让用户修改支付信息）
...
try {
    ...
    print "<script>alert(‘订单支付异常，请联系客服！错误码：10052.’)</script>";
   // header('location: ../faildpay.php');
}
?>
