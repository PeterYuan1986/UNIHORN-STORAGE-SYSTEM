...
if (isset($_POST['search'])) {
    $sql = "SELECT * FROM ncstock where productlist LIKE '%" . @$_POST['searchtext'] . "%' OR tracking LIKE '%" . @$_POST['searchtext'] . "%' OR subject LIKE '%" . @$_POST['searchtext'] . "%' ORDER BY " . $column . ' ' . $sort_order;
} else {
